...
>
    ...
    <div
        x-show="show"
        class="mb-6 bg-white dark:bg-[#101922] rounded-xl overflow-hidden shadow-xl transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto border border-slate-200 dark:border-slate-800"
        x-transition:enter="ease-out duration-300"
